...
function [ z,phi ] = conduit_soliton_newton_cg( amplitude,Nexp,L,debug)
% Amplitude: soliton amplitude (assumes unit background)

% Nexp:      Increase the exponent to get better accuracy
%            Decrease the exponent to get faster code
% L:         This code will compute a soliton on the domain [-L, L].
%debug:      Set to 1 to see debugging information, plots, etc.
